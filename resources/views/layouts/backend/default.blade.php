            ...
            <li class="dropdown">
                ...
                <ul class="dropdown-menu dropdown-user">
                    <li class = user-info>
                        <div class="row">
                            <div class="col-md-5">
                                <img src="{{ !empty($user->thumb) ? asset($user->thumb) : asset('assets/img/user.png') }}"
                            ...
                            <div class="col-md-7">
                                <div class="user-text">
                                    ...
                                    <p>{{ $user->email }}</p>
                                    <p><a href="{{ route('admin.user') }}" class="btn btn-primary">Редагувати профіль</a></p>
                                    <p><a href="{{ route('admin.user.changePass') }}" class="btn btn-primary">Змінити паріль</a></p>
                                </div>
                            </div>
                        </div>
                    </li>
