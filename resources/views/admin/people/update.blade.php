...
<section>
    <form action="{{ route('admin.people.postUpdate', ['id' => $person->id]) }}" class="form form-horizontal" method="post" enctype="multipart/form-data">
        <div class="form-group{{ $errors->has('first_name') ? ' has-error' : ''}}">
            <label for="first_name" class="control-label col-md-2">Ім'я</label>
            <div class="col-md-10">
                <input type="hidden" name="_token" value="{{ csrf_token() }}">
                <input class="form-control" id="first_name" name="first_name" value="{{ $person->first_name }}">
        ...
        <div class="form-group{{ $errors->has('last_name') ? ' has-error' : ''}}">
            ...
            <div class="col-md-10">
                <input class="form-control" id="last_name" name="last_name" value="{{ $person->last_name }}">
        ...
        <div class="form-group">
            <div class="col-md-10 col-md-offset-2">
                @if(!empty($person->thumbUrl))
                <img src="{{ asset($person->thumbUrl) }}">
                @endif
            </div>
        </div>
        ...
        <div class="form-group{{ $errors->has('position') ? ' has-error' : ''}}">
            ...
            <div class="col-md-10">
                <input class="form-control" id="position" name="position" value="{{ $person->position }}">
        ...
        <div class="form-group{{ $errors->has('vk') ? ' has-error' : ''}}">
            ...
            <div class="col-md-10">
                <input class="form-control" id="vk" name="vk" value="{{ $person->vk }}">
                @if($errors->has('vk'))
        ...
        <div class="form-group{{ $errors->has('facebook') ? ' has-error' : ''}}">
            ...
            <div class="col-md-10">
                <input class="form-control" id="facebook" name="facebook" value="{{ $person->facebook }}">
        ...
        <div class="form-group{{ $errors->has('skype') ? ' has-error' : ''}}">
            ...
            <div class="col-md-10">
                <input class="form-control" id="skype" name="skype" value="{{ $person->skype }}">
                @if($errors->has('skype'))
        ...
        <div class="form-group{{ $errors->has('twitter') ? ' has-error' : ''}}">
            ...
            <div class="col-md-10">
                <input class="form-control" id="twitter" name="twitter" value="{{ $person->twitter }}">
