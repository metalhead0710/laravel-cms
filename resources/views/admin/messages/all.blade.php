        ...
        <div class="col-md-12">
            <div class="col-md-2">
                <ul class="nav nav-pills nav-stacked">
                    <li><a href="{{route('admin.messages')}}">Нові</a></li>
                    <li><a href="{{route('admin.messages.read')}}">Прочитані</a></li>
                    <li class="active"><a href="{{route('admin.messages.all')}}">Всі</a></li>
                </ul>
            </div>
            <div class="col-md-10">
                <div class="tab-content">
                    <table class="table table-hover">
                        ...
                        <form method="post" class="form-messages">
                            ...
                            <tr data-id="{{ $message->id }}" data-toggle="tooltip" data-delay='{"show":"5000", "hide":"3000"}' data-placement="top" title="Натисніть на повідомлення, щоб переглянути його">
                                <td class="cell-middle">
                                    <input type="checkbox" class="ids" name="ids[]" value="{{ $message->id }}"/>
                                </td>
                                <td>
                                    @if($message->isNew)
                                        <span class="badge" style="background: #b94a48">Нове</span><br>
                                    @endif
                                    {{ $message->sendname}} <br>
                        ...
                        <tfoot>
                        <tr>
                            <td class="text-center" colspan="4">{{ $messages->render() }}</td>
                        </tr>
                        </tfoot>
                    </table>
                </div>
