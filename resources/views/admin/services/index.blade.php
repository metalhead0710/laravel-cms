                ...
                <div class="box-body">
                    <table id="product-table" class="table table-hover">
                        ...
                        <tr>
                            <td class="cell-middle">
                                <div class="dropdown">
                                    ...
                                    <ul class="dropdown-menu pull-right">
                                        ...
                                        <li class="evil">
                                            <a href="#delete-modal" data-toggle='modal' title="Видалити" data-link="{{ route('admin.services.delete', ['id' => $service->id]) }}" class="delete" >
                            ...
                            <td>
                                <img src="{{ asset($service->pic) }}" class="img-responsive" />
                            </td>
                            <td class="cell-middle">
                                {{$service->name}}
                            </td>
                            <td class="cell-middle">
                                {!! str_limit($service->description, 300, '...') !!}
                            </td>
                        </tr>
                        @endforeach
                        </tbody>
